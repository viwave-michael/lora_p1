...
ActiveRecord::Schema.define(version: 20151119030005) do
  ...
  create_table "help_call_answers", force: :cascade do |t|
    t.integer  "device_id"
    t.integer  "help_call_id"
    t.datetime "when"
    t.float    "lng"
    t.float    "lat"
    t.datetime "created_at",   null: false
  ...
  add_index "help_call_answers", ["device_id"], name: "index_help_call_answers_on_device_id"
  add_index "help_call_answers", ["help_call_id"], name: "index_help_call_answers_on_help_call_id"
  ...
  add_index "help_calls", ["device_id"], name: "index_help_calls_on_device_id"
