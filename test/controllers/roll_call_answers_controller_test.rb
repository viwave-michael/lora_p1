...
class RollCallAnswersControllerTest < ActionController::TestCase
  ...
  test "should get index" do
    ...
    assert_not_nil assigns(:roll_call_answers)
  end
  ...
  test "should create roll_call_answer" do
    assert_difference('RollCallAnswer.count') do
      post :create, roll_call_answer: { device_id: @roll_call_answer.device_id, lat: @roll_call_answer.lat, lng: @roll_call_answer.lng, roll_call_id: @roll_call_answer.roll_call_id, when: @roll_call_answer.when }
    end
